...
var media_manager = require('./media_manager-3f766505.js');
require('./loglevel.min.js');
...
class WebSocketAdaptor {
  ...
  checkBackendInstanceUp(data, callbackConnected) {
    var _this = this;
    return media_manager._asyncToGenerator(function* () {
...
class WebRTCAdaptor {
  ...
  constructor(initialValues) {
     ...
     */
    this.mediaManager = new media_manager.MediaManager({
  ...
  enableAudioLevel(stream, streamId) {
    var soundMeter = new soundmeter.SoundMeter(this.mediaManager.audioContext);
 ...
 * @type {Array<Function>}
 */
media_manager._defineProperty(WebRTCAdaptor, "pluginInitMethods", new Array());
